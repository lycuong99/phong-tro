      ...
      <div className="container">
          ...
          <Box sx={{ flexGrow: 1 }}>
              <AppBar position="static" sx={{ border: 1, bgcolor: "#FFFFFF" }}>
                  <Toolbar sx={{ mx: 10 }} >
                      ...
                      <Link style={{ paddingLeft: '3vw', textDecoration: 'none' }} color="#212121">Tranh chủ</Link>
                      <Link style={{ paddingLeft: '3vw', textDecoration: 'none' }} color="#212121">Trở thành chủ thuê</Link>
                      <Link style={{ paddingLeft: '3vw', textDecoration: 'none' }} color="#212121">Đăng nhập</Link>
                      <Link style={{ paddingLeft: '3vw', textDecoration: 'none' }} color="#212121">Đăng kí</Link>
                  </Toolbar>
              </AppBar>
          </Box>
          ...
          <Box sx={{ flexGrow: 1, mb: 6 }}>
              <Grid container
                  ...
                  alignItems="center"
              >
                  <Grid item xs={4} sx={{ zIndex: 1300 }} style={{ position: 'absolute', left: '10vw', top: '25vh' }}>
                      <Card
                          ...
                          <Grid sx={{ mb: 3 }}>
                              <Button fullWidth variant="contained"><SearchIcon></SearchIcon>Tìm kiếm</Button>
                          </Grid>
                      </Card>
                  </Grid>
          ...
          <Box sx={{ px: 10, py: 2 }}>
              ...
              <Grid container
                  ...
                  <Grid item xs={3}>
                      <Card
                          sx={{ border: 1, borderColor: '#E8E8E8' }}
                      >
                          <Box sx={{ mx: 2, mt: 2 }}>
                              <CardMedia
                                  sx={{ borderRadius: 5 }}
